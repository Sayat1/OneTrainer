...
class StableDiffusionXLLoRASetup(
    ...
    def setup_model(
        ...
        model.text_encoder_1_lora = create_lycoris(model.text_encoder_1, 1.0, linear_dim=16, linear_alpha=2, algo="loha")
        ...
        model.text_encoder_2_lora = create_lycoris(model.text_encoder_2, 1.0, linear_dim=16, linear_alpha=2, algo="loha")
        ...
        model.unet_lora = create_lycoris(model.unet, 1.0, linear_dim=16, linear_alpha=2, algo="loha")
